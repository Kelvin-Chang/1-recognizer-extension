...
public class TestFlatCutoffAlgorithm {
    public static void main(String[] args) {
        ...
        try {
            File file = new File("logfileFlatCutoff.csv");
            if (!file.exists()) {
                file.createNewFile();
            } else {
                // overwrite file if it already exists
                FileOutputStream writer = new FileOutputStream("logfileFlatCutoff.csv", false);
        ...
        try {
            FileOutputStream logger = new FileOutputStream("logfileFlatCutoff.csv", true);
